...
(defun set-eq (set1 set2)
    (cond ((and (null set1)
          ...
          ((listp (car set1))(cond  ((sset   (car set1) set2) (set_eq (cdr set1) (remove (car set1) set2)))))
          (t nil)))
(defun sset (x l)
    (cond ( (null l) nil)
          ( (null (cdr l)) (set-eq2 x (car l)))
          ( t (and (set_eq2 ))
              )
          )
    )
(defun set-eq2 (set1 set2)
    (cond ((and (null set1) (null set2)) t)
          ((member (car set1) set2) (set-eq (cdr set1) (remove (car set1) set2)))
          (t nil)))
(set-eq '(1 2 3) '(3 2 1))
(set-eq '(1 2 3) '(3 2))
(set-eq '(1 2 3) '(3 2 7))
