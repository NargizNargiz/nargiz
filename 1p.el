...
(mapcar 'car (unlist4 (del_nil (mapcar 'fun_check (unlist4 (unlist 'list (newf1 '((x y) (x y z))) (newf1 '((0 0) (1 1 0)))))))))
...
(defun check2 (l1 L);; в L ищет такой подписок l1
    (cond ((null l1) nil)
          ;;((null L) nil)
          ;;((null (cdr L)) (set-eq (list (car l1) (che (cadr l1))) (car L)))  x& not x = 0
          ;;(t (or (set-eq (list (car l1) (che (cadr l1))) (car L)) (check2 l1 (cdr L))))
          ((null (cdr L)) (set-eq l1 (car L))) ;;x&x =x  xVx = x
...
(che (cadar '((x 1)) ))
(car '(x 0))
(defun fun_check (l) ;; для (x x) (0 1)
    (cond ( (null l) nil)
          ( (null (cddr l)) (cond ( (not (set-eq (list (caar l) (che (cadar l))) (cadr l)))  l ) ))
          ( (or (check2 (car l) (cdr l)) (fun_check (cdr l))) nil )
          ( t l)
          ))
(defun fun_check2 (l res)
    (cond ( (null l) res )
          ( (null (cddr l))  (cond ( (set-eq (car l) (cadr l))  (cons (car l) res) ) ) )
          ( (check2 (car l) (cdr l)) (fun_check2 (delete (car l) (cdr l)) (cons (car l) res) ))
          (t (fun_check2 (cdr l) (cons (car l) res)))
          ))

(null (cddr '( (w 2) (x 0) )))
(set-eq (list (caar '( (w 2) (x 0) )) (che (cadar))) (cadr l))
(fun_check '( (x 1)  (x 1) ))
